...
public class TowerManager {
    ...
    private void loadTowerImgs() {
        ...
        towerImgs[2] = atlas.getSubimage(7 * 32, 32 * 2, 32, 32);
        towerImgs[3] = atlas.getSubimage(4 * 32, 0, 32, 32);
        towerImgs[4] = atlas.getSubimage(4 * 32, 2 * 32, 32, 32);
        towerImgs[5] = atlas.getSubimage(5 * 32, 0, 32, 32);
        towerImgs[6] = atlas.getSubimage(5 * 32, 2 * 32, 32, 32);
    }
